          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <nav className="space-y-2">
                <Link href="/sudo" className="block text-callout font-medium text-label-primary hover:text-primary transition-colors duration-200 focus-ring-inset rounded-md px-3 py-2">
                  Sudo
                </Link>
                <Link href="/xvii" className="block text-callout font-medium text-label-primary hover:text-primary transition-colors duration-200 focus-ring-inset rounded-md px-3 py-2">
                  XVII
                </Link>
                <Link href="/teyo" className="block text-callout font-medium text-label-primary hover:text-primary transition-colors duration-200 focus-ring-inset rounded-md px-3 py-2">
                  Teyo
                </Link>
              </nav>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><Link href="/about" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">About Us</Link></li>
                  <li><Link href="/contact" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Contact</Link></li>
                  <li><Link href="/size-guide" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Size Guide</Link></li>
                  <li><Link href="/shipping" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Shipping</Link></li>
                  <li><Link href="/returns" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Returns</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">English</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Français</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Español</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Deutsch</a></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-4">
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Sustainable Fabrics</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Eco-Friendly Dyes</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Recycled Materials</a></li>
                  <li><a href="#" className="text-callout text-label-tertiary hover:text-white transition-colors focus-ring">Zero Waste</a></li>
                </ul>
              </div>
            ...
            <div className="border-t border-separator pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              ...
              <div className="flex items-center space-x-8">
                <a href="#" className="text-footnote text-label-tertiary hover:text-white transition-colors focus-ring">
                  Privacy Policy
                </a>
                <a href="#" className="text-footnote text-label-tertiary hover:text-white transition-colors focus-ring">
                  Terms of Service
