          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div>
                ...
                <p className="text-body text-label-secondary leading-relaxed mb-8">
                  Whether you have questions about our products, need styling advice, or want to collaborate with us, we're here to help.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-headline font-medium text-label-primary">Email</p>
                    <p className="text-callout text-label-secondary">hello@espada.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-headline font-medium text-label-primary">Phone</p>
                    <p className="text-callout text-label-secondary">+1 (555) 123-4567</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="text-headline font-medium text-label-primary">Studio</p>
                    <p className="text-callout text-label-secondary">New York, NY</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              <form onSubmit={handleSubmit} className="space-y-6">
                  {/* Name Field */}
                  <div>
                    <label htmlFor="name" className="block text-headline font-medium text-label-primary mb-3">
                      Name
                    </label>
                    <input
                      type="text"
                    ...
                    />
                    {errors.name && (
                      <p className="mt-2 text-caption text-red-500">{errors.name}</p>
                    )}
                  </div>

                  {/* Email Field */}
                  <div>
                    <label htmlFor="email" className="block text-headline font-medium text-label-primary mb-3">
                      Email
                    </label>
                    <input
                      type="email"
                      ...
                      onChange={handleChange}
                      className={`w-full h-12 px-4 rounded-xl border transition-all duration-200 text-body bg-fill-quaternary/50 placeholder:text-label-tertiary focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent ${
                        errors.email ? 'border-red-500' : 'border-separator-opaque'
                      }`}
                      placeholder="your.email@example.com"
                    />
                    {errors.email && (
                      <p className="mt-2 text-caption text-red-500">{errors.email}</p>
                    )}
                  </div>

                  {/* Message Field */}
                  <div>
                    <label htmlFor="message" className="block text-headline font-medium text-label-primary mb-3">
                      Message
                    </label>
                    <textarea
                      id="message"
                      ...
                      className={`w-full px-4 py-3 rounded-xl border transition-all duration-200 text-body bg-fill-quaternary/50 placeholder:text-label-tertiary focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent resize-none ${
                        errors.message ? 'border-red-500' : 'border-separator-opaque'
                      }`}
                      placeholder="Tell us how we can help you..."
                    />
                    {errors.message && (
                      <p className="mt-2 text-caption text-red-500">{errors.message}</p>
                    )}
                  </div>
